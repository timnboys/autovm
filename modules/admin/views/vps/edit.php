...
<?php $list = range(1,30); $list = array_combine($list, $list);?>
	    <?php echo $form->field($model, 'reset_at')->dropDownList($list)->label('Day for Bandwidth reset');?>
            ...
            <?php echo $form->field($model, 'vps_cpu_mhz')->label('CPU Speed (MHZ)');?>
            <?php echo $form->field($model, 'vps_cpu_core')->label('CPU Core');?>
            ...
            <?php echo $form->field($model, 'status')->dropDownList(\app\models\Vps::getStatusList());?>
