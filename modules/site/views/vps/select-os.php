        ...
        function getStatus() {
        	...
        	i = setInterval(function() {
	        	...
	        	$.getJSON(url, function(data) {
					...
					text = "<span><i class=\"material-icons green-text\">done</i></span>Your VPS was sucessfuly installed<br>";
...
<table class="table select-os-table">
    ...
    <tr>
        <td colspan="2">
            ...
            <button class="btn waves-effect waves-light amber" type="button" id="install" data-os="<?php echo Url::toRoute(['os']);?>">Install</button>
        </td>
    </tr>
    </tbody>
</table>
...
<div class="pending" style="display:none;">
	<div class="osInstalling">
	  <div class="row">
	    <div class="col s12">
	      <p class="grey-text steps1"><i class="material-icons">done</i>Prepairing OS Files</p>
	      <p class="grey-text steps2"><i class="material-icons">done</i>Getting Files Ready For Installation</p>
	      <p class="grey-text steps3"><i class="material-icons">done</i>Installing Features</p>
	      <p class="grey-text steps4"><i class="material-icons">done</i>Finishing UP</p>
...
<p class="text-center"><span><i class="material-icons" class="green-text">done</i></span>Your VPS has been created successfully</p>
