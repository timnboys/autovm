...
class Vps extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'server_id', 'datastore_id','hard','vps_ram','vps_cpu_core','vps_cpu_mhz','vps_band_width', 'ip_id', 'os_id', 'plan_id', 'created_at', 'updated_at', 'status', 'reset_at', 'power'], 'integer'],
    ...
    {
        return [
            self::SCENARIO_DEFAULT => ['server_id', 'datastore_id', 'ip_id', 'os_id', 'plan_id', 'hostname', 'password', 'status', 'reset_at', 'disk', 'snapshot'],
        ];
    }
